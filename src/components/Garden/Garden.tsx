...
import { Search, Play, Users, Flower2, ArrowLeft } from 'lucide-react';
    ...
    <Container size="lg" py="xl">
      <Stack gap="xl">
        ...
        <Stack align="center" gap="xs" py="xl">
          ...
          <Text size="sm" c="dimmed">
            <Anchor onClick={() => navigate('/editor')}>Create an engine</Anchor>, then submit it for review to appear in The Garden.
          </Text>
        </Stack>
      </Stack>
    </Container>
